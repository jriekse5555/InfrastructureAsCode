...
Set-AzureRmVMCustomScriptExtension -FileURI $FilePath -Run "test.ps1" -ResourceGroupName "$(ResourceGroup)" -VMName "$(VMName)" -Location "$(Location)" -Name "CustomScriptExtension"
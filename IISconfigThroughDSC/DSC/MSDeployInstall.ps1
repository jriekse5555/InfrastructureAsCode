    ...
    {      
        ...
        Script 'Install' {  
            ...
            SetScript  = {
                ...
                $LocalInstall = [io.path]::combine($env:Temp, 'WebDeploy_amd64_en-US.msi')
                ...
                #Execute Script
                Invoke-Expression -Command 'msiexec /i c:\Software\WebDeploy_amd64_en-US.msi /quiet /norestart'
